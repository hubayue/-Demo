...
- Read: `godot-demo/tests/fixtures/v7.19.2-week-2948-slots.json`
...
func _run() -> void:
    ...
    for expected_slot in fixture.slots:
        ...
        if not _expect(actual.tri == expected.tri, "triangle mismatch at k=%d" % expected.k):
            return
        if not _expect(actual.field == expected.field, "field mismatch at k=%d" % expected.k):
            return
...
- [x] **Step 1: Implement the exact 32-bit random source**
...
- [x] **Step 1: Add the generator and constants**
...
- [x] **Step 2: Run the fixture test and verify GREEN**

Expected: `Godot v7.19.2 weekly slots: PASS`.

- [x] **Step 3: Run all regressions**
